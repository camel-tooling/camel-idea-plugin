...
/**
 * Testing smart completion with Kamelet endpoint in a project with custom Kamelets defined in a maven jar.
 */
public class ProjectKameletEndpointSmartCompletionTestIT extends CamelLightCodeInsightFixtureTestCaseIT {
    ...
    public void testKameletSuggestions() {
        ...
        assertContainsElements(
            strings, "kamelet:chuck-norris-in-jar-source", "kamelet:ftp-source", "kamelet:webhook-source"
        );
    }
}
