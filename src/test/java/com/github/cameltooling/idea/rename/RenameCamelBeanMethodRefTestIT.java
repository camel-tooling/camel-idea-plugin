...
public class RenameCamelBeanMethodRefTestIT extends CamelLightCodeInsightFixtureTestCaseIT {
    ...
    public void testCamelBeanMethodRefRename() {
        ...
        myFixture.checkResultByFile("RenameCamelBeanMethodRefTestData_after.java");

        myFixture.checkResultByFile("RenameCompleteJavaBeanTestData.java",
                "RenameCompleteJavaBeanTestData_after.java",
                true);
    }
