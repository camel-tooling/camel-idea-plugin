...
public class CamelJQAnnotatorTestIT extends CamelLightCodeInsightFixtureTestCaseIT {
    ...
    public void testAnnotatorJQValidation() {
        myFixture.configureByText("AnnotatorTestData.java", getJavaWithJQ());
        myFixture.checkHighlighting(false, false, true, true);
    }

    private String getJavaWithJQ() {
        return """
                ...
                public class MyRouteBuilder extends RouteBuilder {
                        public void configure() throws Exception {
                            from("direct:start")
                            .transform()
                            .jq(<error descr="Encountered "<EOF>" at line 1, column 13>".store.book[a"</error>);
                        }
                    }""";
    }
