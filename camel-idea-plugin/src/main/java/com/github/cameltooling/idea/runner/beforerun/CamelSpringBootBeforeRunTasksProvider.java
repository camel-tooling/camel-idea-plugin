...
public class CamelSpringBootBeforeRunTasksProvider extends AbstractCamelBeforeRunTasksProvider {
    public static final Key<MavenBeforeRunTask> ID = Key.create("Camel.SpringBoot.BeforeRunTask");
    ...
    public CamelSpringBootBeforeRunTask createTask(RunConfiguration runConfiguration) {
        ...
        camelSpringBootBeforeRunTask.setEnabled(runConfiguration instanceof CamelRunConfiguration);
