...
public abstract class AbstractCamelRunnerConfPanel implements PanelWithAnchor, MavenSettingsObservable {

    protected LabeledComponent<TextFieldWithBrowseButton> workingDirComponent;

    protected JCheckBox skipTestsCheckBox;
    protected JPanel panel;
    protected LabeledComponent<EditorTextField> profilesComponent;
    protected JBLabel myFakeLabel;
    protected JCheckBox myResolveToWorkspaceCheckBox;
    protected FixedSizeButton showProjectTreeButton;
    protected JComponent anchor;

    public AbstractCamelRunnerConfPanel(@NotNull Project project) {
    ...
    protected void setData(final MavenRunnerParameters data) {
        ...
        List<String> commandLine = ParametersListUtil.parse(getGoals());
