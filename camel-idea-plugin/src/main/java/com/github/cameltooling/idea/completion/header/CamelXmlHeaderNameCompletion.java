...
/**
 * The {@link CompletionProvider} that gives the name of potential headers in case of XML files.
 */
public class CamelXmlHeaderNameCompletion extends CamelHeaderNameCompletion {

    /**
     * Constructs a {@code CamelXmlHeaderNameCompletion} with the given source of endpoints.
     * @param source the source of endpoints from which we extract the name of headers to propose.
     */
    public CamelXmlHeaderNameCompletion(CamelHeaderEndpointSource source) {
        super(source);
    }
