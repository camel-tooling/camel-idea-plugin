...
/**
 * Testing basic completion with Kamelet option value in a Camel Kamelet binding.
 */
public class CamelKameletOptionValueCompletionIT extends CamelLightCodeInsightFixtureTestCaseIT {
    ...
    protected String getTestDataPath() {
        return "src/test/resources/testData/completion/kamelet/optionvalue";
    }
    ...
    public void testBindingBySource() {
        ...
        List<String> strings = myFixture.getLookupElementStrings();
        assertNotNull(strings);
        assertTrue(strings.contains("text/plain"));
    }
    ...
    public void testBindingBySink() {
        ...
        List<String> strings = myFixture.getLookupElementStrings();
        assertNotNull(strings);
        assertTrue(strings.contains("INFO"));
    }
    ...
    public void testBindingBySteps() {
        ...
        List<String> strings = myFixture.getLookupElementStrings();
        assertNotNull(strings);
        assertTrue(strings.containsAll(Arrays.asList("true", "false")));
        myFixture.type("f");
