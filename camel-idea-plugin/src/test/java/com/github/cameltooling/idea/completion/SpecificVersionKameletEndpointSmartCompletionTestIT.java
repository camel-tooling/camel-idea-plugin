...
/**
 * Testing smart completion with Kamelet endpoint in a project with a specific catalog of Kamelets.
 */
public class SpecificVersionKameletEndpointSmartCompletionTestIT extends CamelLightCodeInsightFixtureTestCaseIT {
    ...
    protected void loadDependencies(@NotNull ModifiableRootModel model) {
        ...
        File artifact = new File("src/test/resources/kamelets-with-catalog/specific-camel-kamelets.jar");
        PsiTestUtil.addLibrary(model, "org.apache.camel.kamelets:camel-kamelets:0-SNAPSHOT", artifact.getParent(), artifact.getName());
    }

    /**
     * Ensure that the name of the specific catalog's Kamelets can be suggested
     */
    public void testKameletSuggestions() {
        ...
        assertContainsElements(strings, "kamelet:ftp-source");
    }
}
