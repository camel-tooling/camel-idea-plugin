...
/**
 * Testing add Camel endpoint intention with Camel XML DSL
 */
public class XmlAddEndpointIntentionTestIT extends CamelLightCodeInsightFixtureTestCaseIT {

    public void testAddCamelEndpoint() {
        myFixture.configureByFiles("XmlAddEndpointIntentionTestData.xml");
