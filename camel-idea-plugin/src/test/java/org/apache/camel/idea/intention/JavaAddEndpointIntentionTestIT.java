...
/**
 * Testing add Camel endpoint intention with Camel Java DSL
 */
public class JavaAddEndpointIntentionTestIT extends CamelLightCodeInsightFixtureTestCaseIT {

    public void testAddCamelEndpoint() {
        myFixture.configureByFiles("JavaAddEndpointIntentionTestData.java");
