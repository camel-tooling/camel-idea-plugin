...
public class CamelProjectComponentTestIT extends ModuleTestCase {
    ...
    public void testAddLibrary() throws IOException {
        ...
        File camelJar = createTestArchive("camel-core-2.21.0.jar");
        ...
        addLibraryToModule(virtualFile, projectLibraryTable, "Maven: org.apache.camel:camel-core:2.21.0-snapshot");
    ...
    public void testRemoveLibrary() throws IOException {
        ...
        VirtualFile camelCoreVirtualFile = LocalFileSystem.getInstance().refreshAndFindFileByIoFile(createTestArchive("camel-core-2.21.0.jar"));
        VirtualFile camelSpringVirtualFile = LocalFileSystem.getInstance().refreshAndFindFileByIoFile(createTestArchive("camel-spring-2.21.0.jar"));

        final LibraryTable projectLibraryTable = LibraryTablesRegistrar.getInstance().getLibraryTable(myProject);

        Library springLibrary = addLibraryToModule(camelSpringVirtualFile, projectLibraryTable, "Maven: org.apache.camel:camel-spring:2.21.0-snapshot");
        Library coreLibrary = addLibraryToModule(camelCoreVirtualFile, projectLibraryTable, "Maven: org.apache.camel:camel-core:2.21.0-snapshot");
    ...
    public void testAddModule() throws IOException {
        ...
        ApplicationManager.getApplication().runWriteAction(() -> {
            ...
            Library library = projectLibraryTable.createLibrary("Maven: org.apache.camel:camel-core:2.21.0-snapshot");
    ...
    public void testAddLegacyPackaging() throws IOException {
        ...
        addLibraryToModule(camelCoreVirtualFile, projectLibraryTable, "Maven: org.apache.camel:camel-core:2.21.0-snapshot");
    ...
    public void testAddLibWithoutMavenPackaging() throws IOException {
        ...
        addLibraryToModule(camelCoreVirtualFile, projectLibraryTable, "org.apache.camel:camel-core:2.21.0-snapshot");
